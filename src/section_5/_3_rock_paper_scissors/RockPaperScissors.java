...
public class RockPaperScissors extends JPanel implements ActionListener {
    ...
    //If you don't like these images, you can add "2" to the end of each (e.g. "./img/rock2.png")
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        //1. Run the program and click and image to make a choice. Notice that the computer always makes the same choice.
